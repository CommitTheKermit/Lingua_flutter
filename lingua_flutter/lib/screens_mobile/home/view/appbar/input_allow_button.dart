...
class _InputAllowButtonState extends State<InputAllowButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
      ...
      onPressed: () {
        ...
        setPrefBool('isAllowInput', readProv.model.isAllowInput);
        readProv.notify();
      },
      icon: Image.asset(
        widget.assetName,
        height: widget.iconSize,
        color: readProv.model.isAllowInput ? const Color(0xFF44698F) : const Color(0xFF868e96),
      ),
      color: Colors.white,
    );
  }
