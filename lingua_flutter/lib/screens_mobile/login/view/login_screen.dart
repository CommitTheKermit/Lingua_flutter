...
import 'package:lingua/screens_mobile/login_screens/signup_screens/signup_screen_first.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    loginProv.model.isEmailRecord = getPrefBool('isEmailRecord') ?? false;
    super.initState();
  }
                    ...
                    children: [
                      ...
                      LoginFormField(
                        onSubmitted: (value) async {
                          ...
                          bool condition = await showFutureProgress(
                            futureFn: loginProv.loginCall(),
                          );
                          // bool condition = false;
                          if (condition && mounted) {
                            if (loginProv.model.isEmailRecord) {
                              setPrefBool('isEmailRecord', loginProv.model.isEmailRecord);
                              setPrefString('email', loginProv.model.email);
                            }
                          ...
                          Row(
                            children: [
                              Checkbox(
                                ...
                                value: loginProv.model.isEmailRecord,
                                onChanged: (value) {
                                  loginProv.model.isEmailRecord = value!;
                                  setState(() {});
                                },
                              ),
                              comnText(
                      ...
                      GestureDetector(
                        onTap: () async {
                          await changeScreen(
                              nextScreen: const SignUpScreenFirst(), isReplace: false);
                        },
                        child:
                            comnText('회원가입', colorFont: const Color(0xFF1E4A75), fontSize: 1.75.h),
                      ),
                    ],
                  ),
                ),
