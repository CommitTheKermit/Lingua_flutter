              ...
              child: Row(
                children: [
                  ...
                  Flexible(
                    ...
                    child: InkWell(
                      onTap: () async {
                        await model.topOption.saveOption(key: 'topOption');
                        await model.midOption.saveOption(key: 'midOption');
                        await model.botOption.saveOption(key: 'botOption');
                        await model.readModeOption
                            .saveOption(key: 'readModeOption');

                        HomeProv readProv =
                            Provider.of<HomeProv>(context, listen: false);

                        readProv.model.topOption = model.topOption;
                        readProv.model.midOption = model.midOption;
                        readProv.model.botOption = model.botOption;
                        readProv.model.readModeOption = model.readModeOption;
                        ...
                        .map((e) => DropdownMenuItem(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 2.1.h,
                                  fontFamily:
                                      model.fonts[model.fonts.indexOf(e)],
                                ),
                              ),
                            ))
                        .toList(),
